...
parcelHelpers.export(exports, "useTimedState", ()=>useTimedState);
parcelHelpers.export(exports, "useListControl", ()=>useListControl);
...
const useTimedState = (defaultState, time)=>{
    ...
    const setTimedState = (0, _react.useCallback)((value)=>{
        setState(value);
...
const useListControl = (list, setList, defaultItem, isListItem, exportFileName)=>{
    const [importError, setImportError] = useTimedState("", 5000);
    const [deleteConfirmIndex, setDeleteConfirmIndex] = useTimedState(-1, 2000);
    const isListValid = (0, _react.useCallback)((object)=>{
        if (!Array.isArray(object)) return false;
        if (isListItem && !object.every(isListItem)) return false;
        return true;
    }, [
        isListItem
    ]);
    ...
    const deleteItem = (0, _react.useCallback)((itemIndex)=>{
        ...
        } else setDeleteConfirmIndex(itemIndex);
    }, [
        setList,
        list,
        deleteConfirmIndex,
    ...
    const onImportList = (0, _react.useCallback)((json)=>{
        if (json && isListValid(json)) {
            setList(json);
            setImportError("");
        } else setImportError("The file provided failed to be matched.");
    }, [
        isListValid,
        setList,
        setImportError
    ]);
    const { getRootProps, getInputProps, open } = (0, _reactDropzone.useDropzone)({
        onDrop: (acceptedFiles)=>{
            (0, _utils.fileToJSON)(acceptedFiles, onImportList, setImportError);
        },
        accept: {
            "application/json": [
                ".json"
    ...
    const exportList = (0, _react.useCallback)(()=>{
        (0, _utils.exportJSON)(list, exportFileName || "list.json");
    }, [
        list,
        exportFileName
    ]);
...
},{"react":"bH1AQ","@parcel/transformer-js/src/esmodule-helpers.js":"hvLRG","lodash":"iyL42","./utils":"2gdT3","react-dropzone":"gDtXJ"}],"gDtXJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ErrorCode", ()=>(0, _indexJs.ErrorCode));
/**
...
Dropzone.propTypes = {
   ...
   * for example, are reported as text/plain under macOS but as application/vnd.ms-excel under
   * Windows. In some cases there might not be a mime type set at all (https://github.com/react-dropzone/react-dropzone/issues/276).
   */ accept: (0, _propTypesDefault.default).objectOf((0, _propTypesDefault.default).arrayOf((0, _propTypesDefault.default).string)),
    /**
   ...
   */ onFileDialogOpen: (0, _propTypesDefault.default).func,
    /**
   * Set to true to use the https://developer.mozilla.org/en-US/docs/Web/API/File_System_Access_API
   * to open the file picker instead of using an `<input type="file">` click event.
   */ useFsAccessApi: (0, _propTypesDefault.default).bool,
    /**
...
function useDropzone() {
    ...
    var acceptAttr = (0, _react.useMemo)(function() {
        return (0, _indexJs.acceptPropAsAcceptAttr)(accept);
    }, [
        accept
    ]);
    var pickerTypes = (0, _react.useMemo)(function() {
        return (0, _indexJs.pickerOptionsFromAccept)(accept);
    }, [
        accept
    ]);
    var onFileDialogOpenCb = (0, _react.useMemo)(function() {
        return typeof onFileDialogOpen === "function" ? onFileDialogOpen : noop;
    }, [
        onFileDialogOpen
    ]);
    var onFileDialogCancelCb = (0, _react.useMemo)(function() {
   ...
   */ var rootRef = (0, _react.useRef)(null);
    ...
    var fsAccessApiWorksRef = (0, _react.useRef)(typeof window !== "undefined" && window.isSecureContext && useFsAccessApi && (0, _indexJs.canUseFileSystemAccessAPI)()); // Update file dialog active state when the window is focused on
    ...
    (0, _react.useEffect)(function() {
        if (preventDropOnDocument) {
            document.addEventListener("dragover", (0, _indexJs.onDocumentDragOver), false);
            document.addEventListener("drop", onDocumentDrop, false);
        }
        return function() {
            if (preventDropOnDocument) {
                document.removeEventListener("dragover", (0, _indexJs.onDocumentDragOver));
    ...
    var onErrCb = (0, _react.useCallback)(function(e) {
        if (onError) onError(e);
        else // Let the user know something's gone wrong if they haven't provided the onError cb.
        console.error(e);
    }, [
        onError
    ]);
    var onDragEnterCb = (0, _react.useCallback)(function(event) {
        ...
        if ((0, _indexJs.isEvtWithFiles)(event)) Promise.resolve(getFilesFromEvent(event)).then(function(files) {
            if ((0, _indexJs.isPropagationStopped)(event) && !noDragEventsBubbling) return;
            var fileCount = files.length;
            var isDragAccept = fileCount > 0 && (0, _indexJs.allFilesAccepted)({
                files: files,
                accept: acceptAttr,
                minSize: minSize,
                maxSize: maxSize,
    ...
    var onDragOverCb = (0, _react.useCallback)(function(event) {
        ...
        event.persist();
        stopPropagation(event);
        var hasFiles = (0, _indexJs.isEvtWithFiles)(event);
    ...
    var onDragLeaveCb = (0, _react.useCallback)(function(event) {
        ...
        if ((0, _indexJs.isEvtWithFiles)(event) && onDragLeave) onDragLeave(event);
    }, [
        rootRef,
        onDragLeave,
        noDragEventsBubbling
    ]);
    var setFiles = (0, _react.useCallback)(function(files, event) {
        var acceptedFiles = [];
        var fileRejections = [];
        files.forEach(function(file) {
            var _fileAccepted = (0, _indexJs.fileAccepted)(file, acceptAttr), _fileAccepted2 = _slicedToArray(_fileAccepted, 2), accepted = _fileAccepted2[0], acceptError = _fileAccepted2[1];
            var _fileMatchSize = (0, _indexJs.fileMatchSize)(file, minSize, maxSize), _fileMatchSize2 = _slicedToArray(_fileMatchSize, 2), sizeMatch = _fileMatchSize2[0], sizeError = _fileMatchSize2[1];
        ...
        if (!multiple && acceptedFiles.length > 1 || multiple && maxFiles >= 1 && acceptedFiles.length > maxFiles) {
            ...
            acceptedFiles.forEach(function(file) {
                fileRejections.push({
                    file: file,
                    errors: [
                        (0, _indexJs.TOO_MANY_FILES_REJECTION)
                    ]
                });
            });
    ...
    var openFileDialog = (0, _react.useCallback)(function() {
        ...
        if (fsAccessApiWorksRef.current) {
            ...
            window.showOpenFilePicker(opts).then(function(handles) {
                ...
                if ((0, _indexJs.isAbort)(e)) {
                    onFileDialogCancelCb(e);
                    dispatch({
                        type: "closeDialog"
                    });
                } else if ((0, _indexJs.isSecurityError)(e)) {
    ...
    var onClickCb = (0, _react.useCallback)(function() {
        ...
        if ((0, _indexJs.isIeOrEdge)()) setTimeout(openFileDialog, 0);
        else openFileDialog();
    }, [
        noClick,
        openFileDialog
    ...
    var getRootProps = (0, _react.useMemo)(function() {
        return function() {
            ...
            return _objectSpread(_objectSpread(_defineProperty({
                onKeyDown: composeKeyboardHandler((0, _indexJs.composeEventHandlers)(onKeyDown, onKeyDownCb)),
                onFocus: composeKeyboardHandler((0, _indexJs.composeEventHandlers)(onFocus, onFocusCb)),
                onBlur: composeKeyboardHandler((0, _indexJs.composeEventHandlers)(onBlur, onBlurCb)),
                onClick: composeHandler((0, _indexJs.composeEventHandlers)(onClick, onClickCb)),
                onDragEnter: composeDragHandler((0, _indexJs.composeEventHandlers)(onDragEnter, onDragEnterCb)),
                onDragOver: composeDragHandler((0, _indexJs.composeEventHandlers)(onDragOver, onDragOverCb)),
                onDragLeave: composeDragHandler((0, _indexJs.composeEventHandlers)(onDragLeave, onDragLeaveCb)),
                onDrop: composeDragHandler((0, _indexJs.composeEventHandlers)(onDrop, onDropCb)),
    ...
    var getInputProps = (0, _react.useMemo)(function() {
        return function() {
            ...
            var inputProps = _defineProperty({
                ...
                onChange: composeHandler((0, _indexJs.composeEventHandlers)(onChange, onDropCb)),
                onClick: composeHandler((0, _indexJs.composeEventHandlers)(onClick, onInputElementClick)),
                tabIndex: -1
            }, refKey, inputRef);
...
},{"react":"bH1AQ","prop-types":"4nQRB","file-selector":"a4GZG","./utils/index.js":"83cP5","@parcel/transformer-js/src/esmodule-helpers.js":"hvLRG"}],"4nQRB":[function(require,module,exports) {
/**
...
},{"96e34ae03f5a2631":"jorYx","cb216452e2171041":"1hXKM"}],"jorYx":[function(require,module,exports) {
"use strict";
module.exports = require("2255125a8e8b1051");

},{"2255125a8e8b1051":"3BcZY"}],"3BcZY":[function(require,module,exports) {
...
},{}],"1hXKM":[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"c437388b089702c3":"jorYx","c067a60101d8520c":"bNXVA","74a0f89a70b9f3c2":"bZWAr","18441b11647bc78":"1ojSU","bec3f6ff89f0b072":"9LQJE"}],"bNXVA":[function(require,module,exports) {
/*
object-assign
(c) Sindre Sorhus
@license MIT
...
},{}],"bZWAr":[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{}],"1ojSU":[function(require,module,exports) {
module.exports = Function.call.bind(Object.prototype.hasOwnProperty);

},{}],"9LQJE":[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"24ba1e58d167a82c":"bZWAr","898bc82f39d83f7c":"1ojSU"}],"a4GZG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fromEvent", ()=>(0, _fileSelector.fromEvent));
var _fileSelector = require("./file-selector");

},{"./file-selector":"dv4XQ","@parcel/transformer-js/src/esmodule-helpers.js":"hvLRG"}],"dv4XQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
...
function getInputFiles(evt) {
    return fromList(evt.target.files).map((file)=>(0, _file.toFileWithPath)(file));
}
// Ee expect each handle to be https://developer.mozilla.org/en-US/docs/Web/API/FileSystemFileHandle
function getFsHandleFiles(handles) {
    return (0, _tslib.__awaiter)(this, void 0, void 0, function*() {
        const files = yield Promise.all(handles.map((h)=>h.getFile()));
        return files.map((file)=>(0, _file.toFileWithPath)(file));
    });
}
function getDataTransferFiles(dt, type) {
    return (0, _tslib.__awaiter)(this, void 0, void 0, function*() {
        ...
        return noIgnoredFiles(fromList(dt.files).map((file)=>(0, _file.toFileWithPath)(file)));
    });
}
...
function fromDataTransferItem(item, entry) {
    return (0, _tslib.__awaiter)(this, void 0, void 0, function*() {
        ...
        const fwp = (0, _file.toFileWithPath)(file, (_a = entry === null || entry === void 0 ? void 0 : entry.fullPath) !== null && _a !== void 0 ? _a : undefined);
        return fwp;
    });
}
...
function fromDirEntry(entry) {
    ...
    return new Promise((resolve, reject)=>{
        ...
        function readEntries() {
            ...
            reader.readEntries((batch)=>(0, _tslib.__awaiter)(this, void 0, void 0, function*() {
                    if (!batch.length) // Done reading directory
                    try {
...
function fromFileEntry(entry) {
    return (0, _tslib.__awaiter)(this, void 0, void 0, function*() {
        return new Promise((resolve, reject)=>{
            entry.file((file)=>{
                const fwp = (0, _file.toFileWithPath)(file, entry.fullPath);
                resolve(fwp);
            }, (err)=>{
                reject(err);
            });
...
},{"tslib":"lRaYF","./file":"7YIJG","@parcel/transformer-js/src/esmodule-helpers.js":"hvLRG"}],"lRaYF":[function(require,module,exports) {
/******************************************************************************
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"hvLRG"}],"7YIJG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function toFileWithPath(file, path, h) {
    ...
    if (h !== undefined) Object.defineProperty(f, "handle", {
        value: h,
        writable: false,
        configurable: false,
        enumerable: true
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"hvLRG"}],"83cP5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
 ...
 * @returns {boolean}
 */ parcelHelpers.export(exports, "canUseFileSystemAccessAPI", ()=>canUseFileSystemAccessAPI);
/**
 ...
 */ parcelHelpers.export(exports, "pickerOptionsFromAccept", ()=>pickerOptionsFromAccept);
/**
 * Convert the `{accept}` dropzone prop to an array of MIME types/extensions.
 * @param {AcceptProp} accept
 * @returns {string}
 */ parcelHelpers.export(exports, "acceptPropAsAcceptAttr", ()=>acceptPropAsAcceptAttr);
/**
 ...
 */ parcelHelpers.export(exports, "isAbort", ()=>isAbort);
/**
 ...
 */ parcelHelpers.export(exports, "isSecurityError", ()=>isSecurityError);
/**
 ...
 *
 * @param {string} v
 */ parcelHelpers.export(exports, "isMIMEType", ()=>isMIMEType);
/**
 * Check if v is a file extension.
 * @param {string} v
 */ parcelHelpers.export(exports, "isExt", ()=>isExt) /**
...
var accepts = typeof (0, _attrAcceptDefault.default) === "function" ? (0, _attrAcceptDefault.default) : (0, _attrAcceptDefault.default).default; // Error codes
...
},{"attr-accept":"il8tO","@parcel/transformer-js/src/esmodule-helpers.js":"hvLRG"}],"il8tO":[function(require,module,exports) {
"use strict";
...
},{}]},[], null, "parcelRequire156b")

//# sourceMappingURL=time.87d50161.js.map
